...
Serves real-time stock data with network effects, founder leadership, and Cramer tracking
"""
...
# Database of founder-led companies with metadata
FOUNDER_LED_COMPANIES = [
    {
        ...
        "founded_year": 2004,
        "ipo_year": 2012,
        "network_effects_rank": 10,
        "founder_leadership_rank": 10,
        "cramer_recommendation": "sell",
        "cramer_date": "2022-10-25",
        "top_seven": True
    },
    {
        "ticker": "NVDA",
        ...
        "founded_year": 1993,
        "ipo_year": 1999,
        "network_effects_rank": 8,
        "founder_leadership_rank": 10,
        "cramer_recommendation": "sell",
        "cramer_date": "2023-01-15",
        "top_seven": True
    },
    {
        "ticker": "TSLA",
        ...
        "founded_year": 2003,
        "ipo_year": 2010,
        "network_effects_rank": 7,
        "founder_leadership_rank": 10,
        "cramer_recommendation": "sell",
        "cramer_date": "2023-04-20",
        "top_seven": False
    },
    {
        "ticker": "PLTR",
    ...
    },
    {
        ...
        "founded_year": 1997,
        "ipo_year": 2002,
        "network_effects_rank": 9,
        "founder_leadership_rank": 8,
        "cramer_recommendation": "buy",
        "cramer_date": "2022-06-10",
        "top_seven": True
    },
    {
        "ticker": "HOOD",
    ...
    },
    {
        ...
        "founded_year": 1991,
        "ipo_year": 2009,
        "network_effects_rank": 6,
        "founder_leadership_rank": 8,
        "cramer_recommendation": None,
        "cramer_date": None,
        "top_seven": True
    },
    {
...
def calculate_ma_recommendation(current_price: float, avg_200_day: float) -> MARecommendation:
    """Calculate buy/sell recommendation based on 200-day MA"""
    percent_above = ((current_price - avg_200_day) / avg_200_day) * 100
    
    if percent_above > 15:
        return MARecommendation(
            action="SELL",
            reason="Well above 200-day moving average",
            percent_above_ma=round(percent_above, 2)
        )
    elif percent_above < -5:
        return MARecommendation(
            action="BUY",
            reason="Below 200-day moving average",
            percent_above_ma=round(percent_above, 2)
        )
    else:
        return MARecommendation(
            action="HOLD",
            reason="Near 200-day moving average",
            percent_above_ma=round(percent_above, 2)
        )
...
async def get_all_companies():
    """Get all founder-led companies with live stock data"""
    results = []
...
async def get_company(ticker: str):
    ...
    if not live_data:
        raise HTTPException(status_code=500, detail="Unable to fetch live stock data")
...
async def get_top_seven():
    """Get top 7 performers with 200-day MA recommendations"""
    ...
    for company in top_seven:
        ...
        if live_data:
            recommendation = calculate_ma_recommendation(
                live_data['current_price'],
                live_data['avg_200_day']
            )
